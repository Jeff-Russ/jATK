...
### About: ###
* jATK provides a miriad of classes useful for audio effect and synthesizers, available via the jATK namespace
...
4) High quality ZDF and biquad filters for synthesizers

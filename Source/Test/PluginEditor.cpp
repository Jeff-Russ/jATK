...
void JAtkautesterAudioProcessorEditor::updateFromParameters()
{
...
void JAtkautesterAudioProcessorEditor::setRecordButtonState(bool recording) {
	if (recording) {
...
//==============================================================================
JAtktesterAudioProcessorEditor::JAtktesterAudioProcessorEditor (JAtkautesterAudioProcessor* ownerFilter)
...
JAtktesterAudioProcessorEditor::~JAtktesterAudioProcessorEditor()
{
...
//==============================================================================
void JAtktesterAudioProcessorEditor::paint (Graphics& g)
{
...
void JAtktesterAudioProcessorEditor::resized()
{
    //[UserPreResize] Add your own custom resize code here..
    //[/UserPreResize]

    groupComponent->setBounds (21, 80, 400, 344);
    frequencyComboBox->setBounds (133, 152, 72, 24);
    frequencyLabel->setBounds (37, 152, 80, 24);
    aSlider->setBounds (45, 280, 48, 72);
    aLabel->setBounds (45, 352, 48, 24);
    dSlider->setBounds (109, 280, 48, 72);
    dLabel->setBounds (109, 352, 48, 24);
    sSlider->setBounds (173, 280, 48, 72);
    dLabel2->setBounds (173, 352, 48, 24);
    rSlider->setBounds (237, 280, 48, 72);
    rLabel->setBounds (237, 352, 48, 24);
    attenuationSlider->setBounds (311, 280, 72, 96);
    attenuationLabel->setBounds (311, 384, 96, 24);
    dbLabel->setBounds (375, 352, 40, 24);
    sineImageButton->setBounds (87, 112, 34, 30);
    halfsineImageButton->setBounds (127, 112, 34, 30);
    abssineImageButton->setBounds (167, 112, 34, 30);
    quartersineImageButton->setBounds (207, 112, 34, 30);
    waveLabel->setBounds (37, 112, 48, 24);
    tremoloButton->setBounds (149, 192, 96, 24);
    vibratoButton->setBounds (45, 192, 96, 24);
    sustainButton->setBounds (45, 384, 96, 24);
    keyscaleEnvButton->setBounds (133, 384, 184, 24);
    frequencyLabel2->setBounds (253, 184, 152, 24);
    dbLabel2->setBounds (341, 156, 72, 16);
    groupComponent2->setBounds (426, 80, 400, 344);
    frequencyComboBox2->setBounds (538, 152, 72, 24);
    frequencyLabel3->setBounds (442, 152, 80, 24);
    aSlider2->setBounds (450, 280, 48, 72);
    aLabel2->setBounds (450, 352, 48, 24);
    dSlider2->setBounds (514, 280, 48, 72);
    dLabel3->setBounds (514, 352, 48, 24);
    sSlider2->setBounds (578, 280, 48, 72);
    dLabel4->setBounds (578, 352, 48, 24);
    rSlider2->setBounds (642, 280, 48, 72);
    rLabel2->setBounds (642, 352, 48, 24);
    attenuationSlider2->setBounds (716, 280, 72, 96);
    attenuationLabel2->setBounds (716, 384, 96, 24);
    dbLabel3->setBounds (780, 352, 40, 24);
    sineImageButton2->setBounds (492, 112, 34, 30);
    halfsineImageButton2->setBounds (532, 112, 34, 30);
    abssineImageButton2->setBounds (572, 112, 34, 30);
    quartersineImageButton2->setBounds (612, 112, 34, 30);
    waveLabel2->setBounds (442, 112, 48, 24);
    tremoloButton2->setBounds (562, 192, 96, 24);
    vibratoButton2->setBounds (450, 192, 96, 24);
    sustainButton2->setBounds (450, 384, 96, 24);
    keyscaleEnvButton2->setBounds (538, 384, 184, 24);
    frequencyLabel4->setBounds (658, 184, 152, 24);
    groupComponent3->setBounds (21, 432, 805, 96);
    tremoloSlider->setBounds (628, 456, 112, 24);
    frequencyLabel5->setBounds (477, 456, 152, 24);
    dbLabel5->setBounds (748, 448, 40, 40);
    vibratoSlider->setBounds (628, 488, 112, 24);
    frequencyLabel6->setBounds (477, 488, 152, 24);
    dbLabel6->setBounds (748, 480, 47, 40);
    feedbackSlider->setBounds (117, 232, 136, 24);
    frequencyLabel7->setBounds (37, 232, 80, 24);
    velocityComboBox->setBounds (333, 232, 72, 24);
    attenuationLabel3->setBounds (269, 232, 64, 24);
    velocityComboBox2->setBounds (738, 232, 72, 24);
    attenuationLabel4->setBounds (674, 232, 64, 24);
    alternatingsineImageButton->setBounds (287, 112, 34, 30);
    camelsineImageButton->setBounds (247, 112, 34, 30);
    squareImageButton->setBounds (327, 112, 34, 30);
    logsawImageButton->setBounds (367, 112, 34, 30);
    alternatingsineImageButton2->setBounds (694, 113, 34, 30);
    camelsineImageButton2->setBounds (654, 113, 34, 30);
    squareImageButton2->setBounds (734, 113, 34, 30);
    logsawImageButton2->setBounds (774, 113, 34, 30);
    algorithmComboBox->setBounds (530, 232, 112, 24);
    frequencyLabel8->setBounds (434, 232, 80, 24);
    dbLabel4->setBounds (746, 156, 72, 16);
    keyscaleAttenuationComboBox2->setBounds (674, 152, 72, 24);
    keyscaleAttenuationComboBox->setBounds (269, 152, 72, 24);
    groupComponent4->setBounds (426, 8, 400, 64);
    groupComponent5->setBounds (21, 8, 400, 64);
    emulatorSlider->setBounds (205, 32, 40, 24);
    emulatorLabel->setBounds (117, 32, 72, 24);
    emulatorLabel2->setBounds (253, 32, 72, 24);
    recordButton->setBounds (45, 456, 128, 24);
    percussionComboBox->setBounds (261, 488, 112, 24);
    percussionLabel->setBounds (45, 488, 163, 24);
...
void JAtktesterAudioProcessorEditor::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void JAtktesterAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
...
void JAtktesterAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
...
//[MiscUserCode] You can add your own definitions of your custom methods or any other code here...
    ...
    bool JAtkautesterAudioProcessorEditor::isInterestedInFileDrag (const StringArray& files)
    {
        return 1 == files.size() && (
    ...
    void JAtkautesterAudioProcessorEditor::fileDragEnter (const StringArray& files, int x, int y)
    {
    }

    void JAtkautesterAudioProcessorEditor::fileDragMove (const StringArray& files, int x, int y)
    {
    }

    void JAtkautesterAudioProcessorEditor::fileDragExit (const StringArray& files)
    {
    }

    void JAtkautesterAudioProcessorEditor::filesDropped (const StringArray& files, int x, int y)
    {
	...
	void JAtkautesterAudioProcessorEditor::timerCallback()
	{
...
<JUCER_COMPONENT documentType="Component" className="JAtktesterAudioProcessorEditor"
                 componentName="" parentClasses="public AudioProcessorEditor, public FileDragAndDropTarget, public DragAndDropContainer, public Timer"
                 constructorParams="JAtkautesterAudioProcessor* ownerFilter" variableInitialisers=" AudioProcessorEditor (ownerFilter)"
  ...
  <GROUPCOMPONENT name="new group" id="d2c7c07bf2d78c30" memberName="groupComponent"
                  virtualName="" explicitFocusOrder="0" pos="21 80 400 344" outlinecol="ff007f00"
  ...
  <COMBOBOX name="frequency combo box" id="4e65faf3d9442460" memberName="frequencyComboBox"
            virtualName="" explicitFocusOrder="0" pos="133 152 72 24" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="frequency label" id="7414532477c7f744" memberName="frequencyLabel"
         virtualName="" explicitFocusOrder="0" pos="37 152 80 24" tooltip="Multiplier applied to base note frequency"
  ...
  <SLIDER name="a slider" id="1b9be27726a5b3ae" memberName="aSlider" virtualName=""
          explicitFocusOrder="0" pos="45 280 48 72" tooltip="Envelope attack rate"
  ...
  <LABEL name="a label" id="9dd0b13f00b4de42" memberName="aLabel" virtualName=""
         explicitFocusOrder="0" pos="45 352 48 24" tooltip="Attack rate"
  ...
  <SLIDER name="d slider" id="d4cc8ddf2fc9cf2b" memberName="dSlider" virtualName=""
          explicitFocusOrder="0" pos="109 280 48 72" tooltip="Envelope decay rate"
          thumbcol="ff00af00" trackcol="7f007f00" textboxtext="ff007f00"
          textboxbkgd="ff000000" textboxhighlight="ff00af00" min="0" max="15"
          int="1" style="LinearVertical" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="40" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="d label" id="a7f17b098b85f10b" memberName="dLabel" virtualName=""
         explicitFocusOrder="0" pos="109 352 48 24" tooltip="Decay rate"
  ...
  <SLIDER name="s slider" id="9bcadfc61e498bce" memberName="sSlider" virtualName=""
          explicitFocusOrder="0" pos="173 280 48 72" tooltip="Envelope sustain level"
          thumbcol="ff00af00" trackcol="7f007f00" textboxtext="ff007f00"
          textboxbkgd="ff000000" textboxhighlight="ff00af00" min="0" max="15"
          int="1" style="LinearVertical" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="40" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="d label" id="6467455c7573fefa" memberName="dLabel2" virtualName=""
         explicitFocusOrder="0" pos="173 352 48 24" tooltip="Sustain level"
  ...
  <SLIDER name="r slider" id="5616976a8c5a3f5f" memberName="rSlider" virtualName=""
          explicitFocusOrder="0" pos="237 280 48 72" tooltip="Envelope release rate"
          thumbcol="ff00af00" trackcol="7f007f00" textboxtext="ff007f00"
          textboxbkgd="ff000000" textboxhighlight="ff00af00" min="0" max="15"
          int="1" style="LinearVertical" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="40" textBoxHeight="20" skewFactor="1"/>
  <LABEL name="r label" id="ef30d2907e867666" memberName="rLabel" virtualName=""
         explicitFocusOrder="0" pos="237 352 48 24" tooltip="Release rate"
  ...
  <SLIDER name="attenuation slider" id="dfb943cd83b3977f" memberName="attenuationSlider"
          virtualName="" explicitFocusOrder="0" pos="311 280 72 96" thumbcol="ff00af00"
  ...
  <LABEL name="attenuation label" id="643f88854c82ca3e" memberName="attenuationLabel"
         virtualName="" explicitFocusOrder="0" pos="311 384 96 24" tooltip="Final output level adjustment"
  ...
  <LABEL name="db label" id="666be8c96c85c9f1" memberName="dbLabel" virtualName=""
         explicitFocusOrder="0" pos="375 352 40 24" textCol="ff007f00"
  ...
  <IMAGEBUTTON name="sine image button" id="5e72e0ec4fc09c1a" memberName="sineImageButton"
               virtualName="" explicitFocusOrder="0" pos="87 112 34 30" buttonText="Sine"
  ...
  <IMAGEBUTTON name="half sine image button" id="bf9e0504c5e9e5d5" memberName="halfsineImageButton"
               virtualName="" explicitFocusOrder="0" pos="127 112 34 30" buttonText="Half Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="abs sine image button" id="1b0b532ac934edae" memberName="abssineImageButton"
               virtualName="" explicitFocusOrder="0" pos="167 112 34 30" buttonText="Abs Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="quarter sine image button" id="47d1bd1fd4ae011d" memberName="quartersineImageButton"
               virtualName="" explicitFocusOrder="0" pos="207 112 34 30" buttonText="Quarter Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <LABEL name="wave label" id="d35c942584ea52a6" memberName="waveLabel"
         virtualName="" explicitFocusOrder="0" pos="37 112 48 24" textCol="ff007f00"
  ...
  <TOGGLEBUTTON name="tremolo button" id="1e6ab9b2f1fee312" memberName="tremoloButton"
                virtualName="" explicitFocusOrder="0" pos="149 192 96 24" txtcol="ff007f00"
  ...
  <TOGGLEBUTTON name="vibrato button" id="a989eb6692e3dbd8" memberName="vibratoButton"
                virtualName="" explicitFocusOrder="0" pos="45 192 96 24" txtcol="ff007f00"
  ...
  <TOGGLEBUTTON name="sustain button" id="e0ae2bc46ec1861c" memberName="sustainButton"
                virtualName="" explicitFocusOrder="0" pos="45 384 96 24" tooltip="Enable or disable sustain when note is held"
  ...
  <TOGGLEBUTTON name="keyscale env button" id="a3f62a22526b4b49" memberName="keyscaleEnvButton"
                virtualName="" explicitFocusOrder="0" pos="133 384 184 24" tooltip="Speed up envelope rate with note frequency"
  ...
  <LABEL name="frequency label" id="7898903168ad06c2" memberName="frequencyLabel2"
         virtualName="" explicitFocusOrder="0" pos="253 184 152 24" tooltip="Attenuate amplitude with note frequency"
  ...
  <LABEL name="db label" id="b9b3cedf2b541262" memberName="dbLabel2" virtualName=""
         explicitFocusOrder="0" pos="341 156 72 16" textCol="ff007f00"
  ...
  <GROUPCOMPONENT name="new group" id="93b9aaeb75040aed" memberName="groupComponent2"
                  virtualName="" explicitFocusOrder="0" pos="426 80 400 344" outlinecol="ff007f00"
  ...
  <COMBOBOX name="frequency combo box" id="30b8c81b6bd2a17" memberName="frequencyComboBox2"
            virtualName="" explicitFocusOrder="0" pos="538 152 72 24" editable="0"
            layout="33" items="" textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="frequency label" id="65d58d2259c13bf1" memberName="frequencyLabel3"
         virtualName="" explicitFocusOrder="0" pos="442 152 80 24" tooltip="Multiplier applied to base note frequency"
         textCol="ff007f00" edTextCol="ff000000" edBkgCol="0" labelText="Frequency"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="33"/>
  <SLIDER name="a slider" id="d6d2f4556ea9394" memberName="aSlider2" virtualName=""
          explicitFocusOrder="0" pos="450 280 48 72" thumbcol="ff00af00"
          trackcol="7f007f00" textboxtext="ff007f00" textboxbkgd="ff000000"
  ...
  <IMAGEBUTTON name="half sine image button" id="6e9afdb08dd4edac" memberName="halfsineImageButton2"
               virtualName="" explicitFocusOrder="0" pos="532 112 34 30" buttonText="Half Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="half_sine_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="abs sine image button" id="361941cfa04130c1" memberName="abssineImageButton2"
               virtualName="" explicitFocusOrder="0" pos="572 112 34 30" buttonText="Abs Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="abs_sine_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="quarter sine image button" id="3fa62f49fdd1a41f" memberName="quartersineImageButton2"
               virtualName="" explicitFocusOrder="0" pos="612 112 34 30" buttonText="Quarter Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="quarter_sine_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <LABEL name="wave label" id="c810628f3c772781" memberName="waveLabel2"
         virtualName="" explicitFocusOrder="0" pos="442 112 48 24" textCol="ff007f00"
         edTextCol="ff000000" edBkgCol="0" labelText="Wave" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <TOGGLEBUTTON name="tremolo button" id="a517934e39704073" memberName="tremoloButton2"
                virtualName="" explicitFocusOrder="0" pos="562 192 96 24" txtcol="ff007f00"
                buttonText="Tremolo" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="0"/>
  <TOGGLEBUTTON name="vibrato button" id="736b965a99641077" memberName="vibratoButton2"
                virtualName="" explicitFocusOrder="0" pos="450 192 96 24" txtcol="ff007f00"
                buttonText="Vibrato" connectedEdges="0" needsCallback="1" radioGroupId="0"
                state="0"/>
  <TOGGLEBUTTON name="sustain button" id="a3832cb840cae1f2" memberName="sustainButton2"
                virtualName="" explicitFocusOrder="0" pos="450 384 96 24" tooltip="Enable or disable sustain when note is held"
                txtcol="ff007f00" buttonText="Sustain" connectedEdges="0" needsCallback="1"
                radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="keyscale env button" id="4cd968dae86d143c" memberName="keyscaleEnvButton2"
                virtualName="" explicitFocusOrder="0" pos="538 384 184 24" tooltip="Speed up envelope rate with note frequency"
                txtcol="ff007f00" buttonText="Keyscale Envelope Rate" connectedEdges="0"
                needsCallback="1" radioGroupId="0" state="0"/>
  <LABEL name="frequency label" id="a1e2dd50c2835d73" memberName="frequencyLabel4"
         virtualName="" explicitFocusOrder="0" pos="658 184 152 24" tooltip="Attenuate amplitude with note frequency"
         textCol="ff007f00" edTextCol="ff000000" edBkgCol="0" labelText="Keyscale Attenuation"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  <GROUPCOMPONENT name="new group" id="7392f7d1c8cf6e74" memberName="groupComponent3"
                  virtualName="" explicitFocusOrder="0" pos="21 432 805 96" outlinecol="ff007f00"
                  textcol="ff007f00" title="Common" textpos="33"/>
  <SLIDER name="tremolo slider" id="ab64abee7ac8874b" memberName="tremoloSlider"
          virtualName="" explicitFocusOrder="0" pos="628 456 112 24" thumbcol="ff00af00"
          trackcol="7f007f00" textboxtext="ff007f00" textboxbkgd="ff000000"
  ...
  <LABEL name="frequency label" id="134ce8f87da62b88" memberName="frequencyLabel5"
         virtualName="" explicitFocusOrder="0" pos="477 456 152 24" tooltip="OPL global tremolo depth"
  ...
  <LABEL name="db label" id="720df8e7c502dd91" memberName="dbLabel5" virtualName=""
         explicitFocusOrder="0" pos="748 448 40 40" textCol="ff007f00"
         outlineCol="0" edTextCol="ff000000" edBkgCol="0" labelText="dB"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="33"/>
  <SLIDER name="vibrato slider" id="b45a1f20f22cf5ca" memberName="vibratoSlider"
          virtualName="" explicitFocusOrder="0" pos="628 488 112 24" thumbcol="ff00af00"
          trackcol="7f007f00" textboxtext="ff007f00" textboxbkgd="ff000000"
  ...
  <LABEL name="frequency label" id="1412b9d14e37bcbe" memberName="frequencyLabel6"
         virtualName="" explicitFocusOrder="0" pos="477 488 152 24" tooltip="OPL global vibrato depth"
  ...
  <LABEL name="db label" id="e13e0aff8b974a36" memberName="dbLabel6" virtualName=""
         explicitFocusOrder="0" pos="748 480 47 40" tooltip="A unit of pitch; 100 cents per semitone"
  ...
  <SLIDER name="feedback slider" id="f9d22e12f5e417e4" memberName="feedbackSlider"
          virtualName="" explicitFocusOrder="0" pos="117 232 136 24" thumbcol="ff00af00"
          trackcol="7f007f00" textboxtext="ff007f00" textboxbkgd="ff000000"
  ...
  <LABEL name="frequency label" id="880eaf14af62578a" memberName="frequencyLabel7"
         virtualName="" explicitFocusOrder="0" pos="37 232 80 24" tooltip="Extent to which modulator output is fed back into itself"
  ...
  <COMBOBOX name="velocity combo box" id="cbe10e5236447f15" memberName="velocityComboBox"
            virtualName="" explicitFocusOrder="0" pos="333 232 72 24" editable="0"
            layout="33" items="Off&#10;Light&#10;Heavy" textWhenNonSelected=""
            textWhenNoItems="(no choices)"/>
  <LABEL name="attenuation label" id="c78694a1d0c5264c" memberName="attenuationLabel3"
         virtualName="" explicitFocusOrder="0" pos="269 232 64 24" tooltip="Set or disable velocity senstivity"
  ...
  <COMBOBOX name="velocity combo box" id="f5c4883d9feaa700" memberName="velocityComboBox2"
            virtualName="" explicitFocusOrder="0" pos="738 232 72 24" editable="0"
            layout="33" items="Off&#10;Light&#10;Heavy" textWhenNonSelected=""
            textWhenNoItems="(no choices)"/>
  <LABEL name="attenuation label" id="d9297cdef25630de" memberName="attenuationLabel4"
         virtualName="" explicitFocusOrder="0" pos="674 232 64 24" tooltip="Set or disable velocity senstivity"
         textCol="ff007f00" edTextCol="ff000000" edBkgCol="0" labelText="Velocity"
         editableSingleClick="0" editableDoubleClick="0" focusDiscardsChanges="0"
         fontname="Default font" fontsize="15" bold="0" italic="0" justification="33"/>
  <IMAGEBUTTON name="alternating sine image button" id="2a054359a782e92d" memberName="alternatingsineImageButton"
               virtualName="" explicitFocusOrder="0" pos="287 112 34 30" buttonText="Alternating Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="camel sine image button" id="d6f66822f7f64480" memberName="camelsineImageButton"
               virtualName="" explicitFocusOrder="0" pos="247 112 34 30" buttonText="Camel Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="square image button" id="85e53fb506289115" memberName="squareImageButton"
               virtualName="" explicitFocusOrder="0" pos="327 112 34 30" buttonText="Square"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="logsaw image button" id="fca4c858138cdd7b" memberName="logsawImageButton"
               virtualName="" explicitFocusOrder="0" pos="367 112 34 30" buttonText="Logarithmic Sawtooth"
               connectedEdges="0" needsCallback="1" radioGroupId="1" keepProportions="1"
  ...
  <IMAGEBUTTON name="alternating sine image button" id="32c5f60cc145d464" memberName="alternatingsineImageButton2"
               virtualName="" explicitFocusOrder="0" pos="694 113 34 30" buttonText="Alternating Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="alternating_sine_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="camel sine image button" id="215395763c6a03f2" memberName="camelsineImageButton2"
               virtualName="" explicitFocusOrder="0" pos="654 113 34 30" buttonText="Camel Sine"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="camel_sine_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="square image button" id="d85202a2e5f8b158" memberName="squareImageButton2"
               virtualName="" explicitFocusOrder="0" pos="734 113 34 30" buttonText="Square"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="square_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="logsaw image button" id="d713984cff8b67b5" memberName="logsawImageButton2"
               virtualName="" explicitFocusOrder="0" pos="774 113 34 30" buttonText="Logarithmic Sawtooth"
               connectedEdges="0" needsCallback="1" radioGroupId="2" keepProportions="1"
               resourceNormal="logarithmic_saw_png" opacityNormal="0.5" colourNormal="0"
               resourceOver="" opacityOver="0.5" colourOver="0" resourceDown=""
               opacityDown="1" colourDown="0"/>
  <COMBOBOX name="algorithm combo box" id="fffe0faaf234ed7" memberName="algorithmComboBox"
            virtualName="" explicitFocusOrder="0" pos="530 232 112 24" editable="0"
  ...
  <LABEL name="frequency label" id="e60c13739cf857ba" memberName="frequencyLabel8"
         virtualName="" explicitFocusOrder="0" pos="434 232 80 24" tooltip="In additive mode, carrier and modulator output are simply summed rather than modulated"
  ...
  <LABEL name="emulator label" id="22c2c30d0f337081" memberName="emulatorLabel"
         virtualName="" explicitFocusOrder="0" pos="117 32 72 24" tooltip="Use the OPL emulator from the DOSBox project"
  ...
  <LABEL name="emulator label" id="4f8869b5724c0195" memberName="emulatorLabel2"
         virtualName="" explicitFocusOrder="0" pos="253 32 72 24" tooltip="Use the OPL emulator from the ZDoom project"
  ...
  <TOGGLEBUTTON name="record button" id="880010ee79039cbe" memberName="recordButton"
                virtualName="" explicitFocusOrder="0" pos="45 456 128 24" tooltip="Start recording all register writes to a DRO file - an OPL recording file format defined by DOSBox"
  ...
  <COMBOBOX name="percussion combo box" id="75a838b61782e17b" memberName="percussionComboBox"
            virtualName="" explicitFocusOrder="0" pos="261 488 112 24" editable="0"
            layout="33" items="Off&#10;Bass drum&#10;Snare&#10;Tom&#10;Cymbal&#10;Hi-hat"
            textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="percussion label" id="a3400e2e5e8e7900" memberName="percussionLabel"
         virtualName="" explicitFocusOrder="0" pos="45 488 163 24" tooltip="Enable percussion instruments instead of oscillators"
...
static const unsigned char resource_JAtktesterAudioProcessorEditor_full_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,146,73,68,65,84,88,
133,237,151,81,14,64,48,16,68,183,226,94,110,225,18,110,230,146,252,116,35,153,166,97,219,21,131,125,63,66,144,241,76,75,147,136,108,66,192,240,116,0,101,60,61,99,133,253,249,158,32,47,48,162,38,208,64,
237,120,39,52,70,146,224,168,185,250,196,206,102,104,140,68,16,228,232,72,235,59,119,234,10,141,145,8,130,148,51,235,212,120,39,235,117,75,222,230,110,209,24,41,103,86,43,78,163,141,198,72,4,65,250,59,
162,116,126,181,105,140,68,16,196,175,35,74,227,191,238,135,141,40,198,245,208,15,140,24,161,49,178,3,63,99,23,114,126,178,233,88,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::full_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_full_sine_png;
const int JAtktesterAudioProcessorEditor::full_sine_pngSize = 203;

// JUCER_RESOURCE: half_sine_png, 179, "../img/half_sine.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_half_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,122,73,68,65,84,88,
133,237,148,65,10,128,32,20,5,191,209,189,186,69,135,236,22,157,172,22,33,193,72,20,102,248,130,55,155,40,50,198,73,77,17,177,133,0,67,111,129,204,120,251,198,130,251,249,27,145,31,20,201,37,88,224,234,
249,75,100,138,164,224,174,121,58,227,198,101,100,138,88,132,156,107,164,246,159,55,90,43,50,69,44,66,202,147,117,170,252,82,237,184,245,184,200,20,41,79,214,78,200,20,177,8,177,8,177,8,177,8,177,8,177,
8,217,1,254,115,12,122,78,109,41,249,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::half_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_half_sine_png;
const int JAtktesterAudioProcessorEditor::half_sine_pngSize = 179;

// JUCER_RESOURCE: abs_sine_png, 181, "../img/abs_sine.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_abs_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,124,73,68,65,84,88,133,
237,148,81,10,128,32,16,5,215,232,94,221,162,67,118,201,250,81,130,17,209,182,192,13,222,252,21,62,153,125,150,201,204,78,11,192,50,91,160,176,118,87,28,120,222,7,119,126,152,251,65,35,101,34,78,210,122,
255,50,23,166,145,100,252,107,122,19,183,214,121,115,153,48,141,72,132,220,223,200,232,25,147,143,114,97,26,145,8,169,111,214,205,185,147,55,151,9,211,72,125,179,78,34,76,35,18,33,18,33,18,33,18,33,18,
33,18,33,23,197,62,17,185,230,123,254,103,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::abs_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_abs_sine_png;
const int JAtktesterAudioProcessorEditor::abs_sine_pngSize = 181;

// JUCER_RESOURCE: quarter_sine_png, 181, "../img/quarter_sine.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_quarter_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,124,73,68,65,84,
88,133,237,150,81,10,128,32,16,68,215,232,94,221,162,67,118,139,78,150,31,41,209,196,162,174,31,205,199,60,8,177,28,120,77,33,38,51,187,140,128,229,111,129,74,91,228,40,215,40,131,57,154,70,86,247,73,
164,133,137,28,113,35,245,141,118,152,183,136,230,10,52,141,72,4,121,254,17,252,198,189,68,115,0,77,35,18,65,190,251,200,230,172,244,238,207,230,206,123,160,105,36,153,206,35,111,36,130,72,4,145,8,34,
17,68,34,136,68,144,12,123,138,13,78,65,207,81,74,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::quarter_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_quarter_sine_png;
const int JAtktesterAudioProcessorEditor::quarter_sine_pngSize = 181;

// JUCER_RESOURCE: camel_sine_png, 174, "../img/camel_sine.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_camel_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,117,73,68,65,84,88,
133,237,148,209,9,192,32,12,68,99,233,94,221,162,67,118,139,78,86,63,218,80,56,41,129,40,245,62,238,129,136,6,225,229,132,20,51,187,140,128,101,182,128,243,45,114,60,43,91,31,38,242,51,107,115,227,93,
238,201,115,18,154,68,36,130,20,243,57,18,253,117,111,61,128,38,17,137,32,18,65,218,201,186,5,47,122,235,200,121,111,52,137,188,115,100,50,52,137,72,4,145,8,34,17,68,34,136,68,16,137,32,21,146,46,14,97,
109,79,27,36,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::camel_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_camel_sine_png;
const int JAtktesterAudioProcessorEditor::camel_sine_pngSize = 174;

// JUCER_RESOURCE: alternating_sine_png, 197, "../img/alternating_sine.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_alternating_sine_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,140,73,68,65,
84,88,133,99,100,96,96,248,207,48,8,0,211,64,59,0,6,112,59,100,21,20,15,184,67,232,12,88,48,68,96,161,16,134,131,79,35,48,104,66,100,212,33,232,128,145,1,86,142,16,74,11,52,78,43,131,38,68,70,29,130,14,
70,29,130,14,48,75,86,123,2,58,112,201,103,67,233,169,36,186,224,32,132,26,52,33,130,40,71,8,1,26,151,51,131,38,68,70,29,130,14,70,29,130,14,136,207,53,48,64,163,22,220,160,9,145,81,135,160,3,210,211,
8,12,80,185,197,54,12,66,132,202,96,208,132,8,0,67,200,18,200,95,246,147,104,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::alternating_sine_png = (const char*) resource_JAtktesterAudioProcessorEditor_alternating_sine_png;
const int JAtktesterAudioProcessorEditor::alternating_sine_pngSize = 197;

// JUCER_RESOURCE: square_png, 179, "../img/square.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_square_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,122,73,68,65,84,88,133,
237,150,177,17,128,48,12,3,29,142,189,216,130,37,216,44,75,66,99,83,40,85,34,238,80,161,111,146,198,190,143,10,59,45,34,238,16,96,251,91,160,216,223,91,39,59,157,92,185,96,34,197,236,203,216,36,19,153,
68,44,130,88,4,177,8,98,17,100,156,172,199,98,167,217,186,43,207,156,228,50,137,180,96,255,35,181,107,86,119,148,90,34,22,65,44,130,88,4,177,8,50,238,154,85,200,223,188,76,34,252,174,249,8,153,68,30,246,
154,9,40,60,195,35,102,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::square_png = (const char*) resource_JAtktesterAudioProcessorEditor_square_png;
const int JAtktesterAudioProcessorEditor::square_pngSize = 179;

// JUCER_RESOURCE: logarithmic_saw_png, 206, "../img/logarithmic_saw.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_logarithmic_saw_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,34,0,0,0,30,8,6,0,0,0,73,255,204,20,0,0,0,149,73,68,65,
84,88,133,237,150,81,10,128,32,16,68,215,232,94,221,194,75,116,158,46,225,37,235,103,37,24,19,139,218,118,64,31,136,172,32,12,15,87,13,34,178,11,1,147,119,128,204,25,36,233,112,15,226,204,8,130,148,65,
156,206,10,177,17,39,104,130,204,197,74,212,57,65,109,12,177,145,12,154,193,245,143,33,54,178,64,189,65,125,247,142,193,125,200,170,179,26,166,49,18,196,234,63,210,58,91,208,149,52,70,234,93,243,150,134,
1,164,3,35,72,237,94,82,104,140,140,32,200,255,65,162,92,118,78,199,70,42,208,4,177,123,107,30,66,99,228,0,184,114,16,107,149,79,109,141,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::logarithmic_saw_png = (const char*) resource_JAtktesterAudioProcessorEditor_logarithmic_saw_png;
const int JAtktesterAudioProcessorEditor::logarithmic_saw_pngSize = 206;

// JUCER_RESOURCE: channeloff_png, 414, "../img/channeloff.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_channeloff_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,16,0,0,0,16,8,6,0,0,0,31,243,255,97,0,0,0,6,98,75,71,68,0,0,
0,0,0,0,249,67,187,127,0,0,0,9,112,72,89,115,0,0,11,19,0,0,11,19,1,0,154,156,24,0,0,0,7,116,73,77,69,7,222,8,25,20,6,56,156,246,144,159,0,0,0,29,105,84,88,116,67,111,109,109,101,110,116,0,0,0,0,0,67,114,
101,97,116,101,100,32,119,105,116,104,32,71,73,77,80,100,46,101,7,0,0,1,2,73,68,65,84,56,203,165,211,61,78,66,65,20,5,224,143,193,82,119,224,62,104,40,166,196,194,202,10,66,65,137,149,75,120,121,193,21,
216,104,108,164,32,178,128,183,1,94,66,67,66,172,172,140,27,176,178,192,202,70,139,55,26,2,138,2,39,153,102,230,220,159,185,231,220,154,85,100,14,113,138,46,154,233,118,138,17,10,185,183,101,122,88,9,
110,99,129,11,20,104,164,83,164,187,69,226,252,128,204,64,230,67,166,239,55,100,250,137,51,176,86,185,122,104,249,11,153,86,226,182,161,150,254,188,192,185,220,141,255,160,234,242,26,71,117,209,25,142,
229,27,90,95,69,105,46,58,193,107,72,211,30,218,30,67,116,67,146,106,178,67,130,9,154,193,158,8,201,36,113,135,216,136,105,72,14,235,237,144,160,135,81,248,118,92,182,133,10,21,183,129,162,174,244,46,
122,194,157,104,166,244,252,167,145,24,163,35,247,80,79,186,62,138,14,112,43,122,81,154,111,168,60,198,165,220,85,229,196,245,101,186,199,44,233,60,89,26,88,47,181,221,145,27,127,133,212,246,93,231,79,
44,229,73,181,37,137,229,213,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::channeloff_png = (const char*) resource_JAtktesterAudioProcessorEditor_channeloff_png;
const int JAtktesterAudioProcessorEditor::channeloff_pngSize = 414;

// JUCER_RESOURCE: channelon_png, 326, "../img/channelon.png"
static const unsigned char resource_JAtktesterAudioProcessorEditor_channelon_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,16,0,0,0,16,8,6,0,0,0,31,243,255,97,0,0,0,6,98,75,71,68,0,0,0,
0,0,0,249,67,187,127,0,0,0,9,112,72,89,115,0,0,11,19,0,0,11,19,1,0,154,156,24,0,0,0,7,116,73,77,69,7,222,8,25,20,6,39,17,254,157,106,0,0,0,29,105,84,88,116,67,111,109,109,101,110,116,0,0,0,0,0,67,114,
101,97,116,101,100,32,119,105,116,104,32,71,73,77,80,100,46,101,7,0,0,0,170,73,68,65,84,56,203,173,147,177,13,194,48,16,69,159,143,148,176,81,20,101,129,84,84,68,217,5,89,176,0,204,16,193,0,30,0,69,202,
8,169,88,131,12,64,145,139,176,82,64,116,230,117,182,252,206,242,249,159,99,201,145,45,80,1,13,144,235,110,15,180,64,192,51,198,199,221,66,62,0,55,190,83,227,185,207,139,77,36,159,128,11,191,217,83,146,
209,241,248,20,152,110,94,35,207,20,148,60,233,24,156,190,249,133,141,157,104,195,172,84,162,221,182,210,72,244,85,22,114,33,17,209,144,88,233,69,19,102,165,21,32,36,20,8,162,217,174,13,114,141,103,156,
146,216,49,80,146,1,197,74,249,140,231,250,151,97,114,169,227,252,6,230,208,38,246,228,75,209,233,0,0,0,0,73,69,78,68,174,66,96,130,0,0};

const char* JAtktesterAudioProcessorEditor::channelon_png = (const char*) resource_JAtktesterAudioProcessorEditor_channelon_png;
const int JAtktesterAudioProcessorEditor::channelon_pngSize = 326;

...
namespace jATK
{
    ...
    const Audio TWOPI_A = 6.283185307179586476925286766559005768394338798750211641949889184615;
    const Audio PI_A = 3.141592653589793238462643383279502884197169399375105820974944592307;
    
    const PreAudio ZERO_PA = 0.0;
    const PreAudio TWOPI_PA = 6.283185307179586476925286766559005768394338798750211641949889184615;
    ...
    const double TWOPI_D = 6.283185307179586476925286766559005768394338798750211641949889184615;
    const float TWOPI_F =  6.283185307179586476925286766559005768394338798750211641949889184615;
    ...
    template<typename SNum> inline SNum ratio1(SNum phase,SNum ratio) { return wrapMax((phase * ratio), 1.0); }
    template<typename SNum> inline void ratio1_ref(SNum phase,SNum ratio){ wrapMax_ref((phase *= ratio), 1.0); }

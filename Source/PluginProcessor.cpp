...
JAtkAudioProcessor::~JAtkAudioProcessor(){}
//==============================================================================
const String JAtkAudioProcessor::getName() const { return JucePlugin_Name; }
int JAtkAudioProcessor::getNumParameters()       { return totalNumParam;   }
...
bool   JAtkAudioProcessor::silenceInProducesSilenceOut() const { return false; }
double JAtkAudioProcessor::getTailLengthSeconds()        const { return 0.0;   }
int    JAtkAudioProcessor::getNumPrograms()                    { return 0;     }
int    JAtkAudioProcessor::getCurrentProgram()                 { return 0;     }
void   JAtkAudioProcessor::setCurrentProgram (int index)       {               }
const  String JAtkAudioProcessor::getProgramName (int index)   { return String::empty; }
...
//==============================================================================
bool JAtkAudioProcessor::hasEditor() const { return true; }
AudioProcessorEditor* JAtkAudioProcessor::createEditor() {return new JAtkAudioProcessorEditor(this);}
//==============================================================================

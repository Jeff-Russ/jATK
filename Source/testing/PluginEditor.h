...
#ifndef __JUCE_HEADER_19629650E255936C__
#define __JUCE_HEADER_19629650E255936C__
...
/**
	...
	This is the GUI
                                                                    //[/Comments]
*/
class JAtktesterAudioProcessorEditor  : public AudioProcessorEditor,
...
public:
    //==============================================================================
    JAtktesterAudioProcessorEditor (JAtkautesterAudioProcessor* ownerFilter);
    ~JAtktesterAudioProcessorEditor();
...
private:
	...
	JAtkautesterAudioProcessor* processor;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JAtktesterAudioProcessorEditor)
};

//[EndFile] You can add extra defines here...
//[/EndFile]

#endif   // __JUCE_HEADER_19629650E255936C__
